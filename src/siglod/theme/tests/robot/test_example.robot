...
#
#  $ bin/test -s siglod.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src siglod.theme.testing.SIGLOD_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/siglod/theme/tests/robot/test_example.robot
#
